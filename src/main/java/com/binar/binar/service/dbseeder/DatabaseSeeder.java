...
import com.binar.binar.entity.oauth.Client;
import com.binar.binar.entity.oauth.Role;
import com.binar.binar.entity.oauth.RolePath;
import com.binar.binar.entity.oauth.User;
import com.binar.binar.repository.oauth.ClientRepository;
import com.binar.binar.repository.oauth.RolePathRepository;
    ...
    public void insertClients(String password) {
        for (String c: clients) {
            ...
            if (null == oldClient) {
                ...
                oldClient.setAccessTokenValiditySeconds(28800);//seharian kerja : normal 1 jam
